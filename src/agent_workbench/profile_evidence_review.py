...
def render_profile_evidence_review_ticket(
    ...
    lines = [
        ...
        "",
        "Use `agent_workbench_run_context`, `agent_workbench_result_contract`, "
        "and `agent_workbench_review_subject` when those tools are available. "
        "Do not search the filesystem for alternate subject locations when the "
        "review-subject tool is available. Write exactly one result or blocker "
