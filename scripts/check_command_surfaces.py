...
def run_cli_help_check(root: Path) -> list[str]:
    checks = (
        ...
        (
            [sys.executable, "-m", "agent_workbench.cli", "roles", "render", "--help"],
            ("--input", "--output"),
            "agent-workbench roles render --help",
        ),
        (
            [
                sys.executable,
            ...
            ("--input", "--input-dir", "--output"),
            "agent-workbench tokens synthesize --help",
        ),
        (
            [
                sys.executable,
            ...
            ("--input", "--input-dir", "--output"),
            "agent-workbench tokens graph-synthesize --help",
        ),
        (
            [
                sys.executable,
            ...
            ("--input", "--output"),
            "agent-workbench benchmark render --help",
        ),
        (
            [
                sys.executable,
            ...
            ("--input", "--project-root", "--dry-run"),
            "agent-workbench benchmark prepare-worktrees --help",
        ),
        (
            [
                sys.executable,
        ...
        (
            ...
            ("--input", "--output", "--agent-metadata"),
            "agent-workbench graph decide --help",
        ),
    )
    ...
    return [
        ...
        "- `agent-workbench tokens graph-synthesize --help`: ok",
        "- `agent-workbench benchmark render --help`: ok",
        "- `agent-workbench benchmark prepare-worktrees --help`: ok",
        "- `agent-workbench graph validate --help`: ok",
        "- `agent-workbench graph render --help`: ok",
        "- `agent-workbench graph decide --help`: ok",
        "",
    ]
