...
def write_pair(tmp_path, *, kind="initial", review=1, verdict="accepted"):
    ...
    result = {"run_id":"run-1","review_number":review,"verdict":verdict,"bundle_sha256":bundle["bundle_sha256"],"deterministic_acceptance":True,"score":9,"critical_defects":[],"defect_packet":None,"advisor_session_id":"advisor-1","advisor_lineage_id":"line-1"}
