...
**Provenance**: Executed and verified on Linux + code-server (jupyterhub04) on 2026-07-31. Windows steps follow the same design but are unverified until tested.
...
**Save this playbook** for future reference. The setup is one-time; after this, GitHub tools just work.