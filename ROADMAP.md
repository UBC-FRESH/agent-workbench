...
| P105 Matched public-corpus benchmark contract | #621 / PR #626 | `feature/p105-matched-public-corpus-contract` | Active corrective follow-up (#627) |
...
Status: active corrective follow-up — Advisor review found missing fail-closed
validation gates; P106 remains unactivated.
...
- [ ] P105.5 Advisor corrective validation gates (#627)
  ...
  - [ ] Reopen/close the corrective issue only after the repair PR is merged.
